...
import { DEMO_COMPANY, DEMO_CUSTOMERS, generateDemoAppointments } from "../demoData"
...
export default function DemoCustomersPage() {
  ...
  // Formular state (only visual – no actual save)
  ...
  const customerAppointments = selected
    ? appointments.filter(a => a.phone === selected.phone).sort((a, b) => b.date.localeCompare(a.date))
    : []
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-10">
          <div>
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-[#1F2A37]">
              Kunden von <span className="text-[#18A66D]">{DEMO_COMPANY}</span>
            </h1>
            <p className="text-[#6B7280] mt-1 text-sm">{DEMO_CUSTOMERS.length} Kunden gespeichert</p>
          </div>
          ...
          <div className="lg:col-span-2 flex flex-col gap-5">
            ...
            {selected ? (
              ...
              <div className="bg-white border border-[#E5E7EB] rounded-2xl shadow-sm overflow-hidden">
                  ...
                  {customerAppointments.length > 0 && (
                    <div>
                      ...
                      <div className="space-y-2 max-h-48 overflow-y-auto">
                        {customerAppointments.slice(0, 10).map(a => (
                ...
                {/* Demo: Löschen deaktiviert */}
                <div className="px-6 pb-5">
                  <div className="w-full py-2.5 rounded-xl text-sm font-semibold text-center text-[#9CA3AF] border border-[#E5E7EB] bg-[#F7FAFC] cursor-not-allowed">
                    Kunden löschen (Demo)
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white border border-[#E5E7EB] rounded-2xl shadow-sm overflow-hidden">
                ...
                <form onSubmit={handleSave} className="px-6 py-6 flex flex-col gap-4">
                  ...
                  <div className="text-xs text-[#9CA3AF] text-center">
                    Im Demo-Modus werden Eingaben nicht gespeichert.
                  </div>
                </form>
              </div>
            )}
